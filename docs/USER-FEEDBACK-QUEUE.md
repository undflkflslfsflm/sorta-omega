...
| Remove manual “cockpit” work from everyday use; commitments should come from capture/import | Primary Tasks simplification in progress: no add forms, captured task-classified notes visible, reminders folded away; automatic note-to-task/promise conversion is still missing | Verify the new Tasks view, implement and live-test source-linked conversion, then simplify Brain and remaining surfaces |
