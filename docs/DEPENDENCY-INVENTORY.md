...
Lockfile SHA-256: `26e561776dc91f1d716359847f6fa5c25a1af0a21d44f45980a8c433fb6b55dd`
...
| `@sorta/web` | `apps/web/package.json` | 25 |
...
| `chrono` | dependencies | `{ version = "0.4", default-features = false, features = ["clock", "std"] }` |
