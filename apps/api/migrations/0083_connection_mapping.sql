CREATE TABLE IF NOT EXISTS connection_mappings (
  ...
  schema_version text NOT NULL DEFAULT 'connection-mapping-v1' CHECK (schema_version='connection-mapping-v1'),
  datasets jsonb NOT NULL DEFAULT '[]'::jsonb,
  timezone text NOT NULL,
  entity_mapping jsonb NOT NULL,
  extraction_profile text NOT NULL CHECK (extraction_profile IN ('provider_native_v1','owner_export_v1','browser_session_v1')),
