...
import type { ApiTokenSummary, DeviceScope, DeviceSummary, Insight, IntegrationConnection, Interest, PersonalDataImportPreview, PersonalDataItem, SyncAck, SyncBatch, SyncOperation, TokenPair } from "@sorta/contracts";
...
export const api = {
  ...
  syncConnection: (connection:IntegrationConnection) => request<JobHandle>(`${vaultPath}/connections/${connection.id}/sync`,{method:"POST",body:"{}"}),
